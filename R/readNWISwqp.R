...
#'
#' @description Import discrete sample water-quality data from the NWIS
#'database in the Water Quality Portal web service. 
#'This function gets the data from \url{http://www.waterqualitydata.us}. This 
#'function is more restrictive than \code{readSTORETwqp} because it retrieves data only
#'for USGS sites.  
#'
#' @param site a character string of the USGS station identifier.
#' @param params a vector of parameter codes. If blank, then retrieve all
...
#'}
#' @export
#' @seealso \code{\link{readSTORETwqp}}
#' @import RCurl
#' @examples
#' \dontrun{
#' # This example requires an internet connection to run
#'readNWISwqp("01594440","00940")
#' }
readNWISwqp <- function(site, params="", begin.date="", end.date="") {
	## Coding history:
	##    2014Sep09 DLLorenz original Coding from getRawQWData.r
	##
	url <- constructNWISURL(site, params, begin.date, end.date,
													"wqp", format="tsv") 
